...
<?php
	...
	if ($_POST['ordenacio']=='sense'){
	   echo "<p>Files mostrades sense forçar cap ordenació</p>\n";
	} else {
	   echo "<p>Files mostrades ordenades per <b>".$_POST['ordenacio']."</b></p>\n";
	   $consulta=$consulta . " ORDER BY ".$_POST['ordenacio'];
	}
